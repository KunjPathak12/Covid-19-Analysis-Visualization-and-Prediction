...
In this Mini project i had first analyzed and visualized the existing data for covid-19 and then using the Prophet library will Predicted the (future) for the Positive Cases , Death Toll, Recovered Cases.
